      ...
      <main className="pt-24 bg-slate-50 min-h-screen">
        ...
        <section className="sticky top-[56px] sm:top-[60px] z-30 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="hidden sm:inline-flex p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-gray-700 hover:text-[#2563eb] transition-colors shrink-0 shadow-sm border border-gray-200"
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold whitespace-nowrap transition-all duration-300 ${selectedFilter === cat.slug
                    ? 'bg-[#2563eb] text-amber-400 shadow-md scale-105'
                  ...
                  return (
                    ...
                    >
                      {!isFailed ? (
                        ...
                        /* Fallback card */
                        <div className="w-full h-full bg-gradient-to-br from-[#2563eb] to-slate-800 p-4 flex flex-col items-center justify-center text-center text-white">
                          <ImageIcon size={32} className="text-amber-400 mb-2 opacity-80" />
                          <p className="text-xs font-bold text-amber-300 mb-1">{item.title}</p>
                          <span className="text-[10px] text-gray-400">Shakti Workforce Private Limited Operations</span>
                        </div>
                      )}
        ...
        {activeModalIndex !== null && (
          ...
          >
            {/* Modal Container */}
            <div
              className="relative max-w-5xl w-full bg-[#2563eb] rounded-3xl overflow-hidden shadow-2xl border border-amber-500/30"
            ...
            >
              ...
              {/* Modal Bottom Bar */}
              <div className="p-5 sm:p-6 bg-[#2563eb] text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-white/10">
                <div>
        ...
        {/* Bottom CTA Banner */}
        <section className="py-16 bg-[#1e3a8a] text-white border-t border-white/10">
