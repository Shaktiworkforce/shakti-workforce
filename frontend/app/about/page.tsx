...
export const metadata: Metadata = {
  title: 'About Us | Shakti Workforce Private Limited',
  description:
    'Learn about Shakti Workforce Private Limited — India’s trusted provider of PSARA-compliant private security, skilled manpower, housekeeping, and facility management.',
};
      ...
      <main className="pt-24 bg-slate-50">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Shakti Workforce Private Limited is a premier Indian security, facility management, and workforce solution provider headquartered in Bhiwandi, Maharashtra, serving corporate, commercial, industrial, and government organizations.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-extrabold text-[#2563eb] mb-6 leading-tight">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-amber-50/70 border border-amber-200/60">
                    <h3 className="font-bold text-[#2563eb] text-base mb-1">100% Statutory Compliant</h3>
                    <p className="text-xs text-gray-600">Strict compliance with PF, ESIC, GST, Minimum Wages & Labour laws.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-slate-100 border border-slate-200">
                    <h3 className="font-bold text-[#2563eb] text-base mb-1">24/7 Field Supervision</h3>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-5 items-center">
                <div className="space-y-4 sm:space-y-5">
                  ...
                  <div className="bg-[#2563eb] text-white p-5 sm:p-7 rounded-3xl shadow-xl min-h-[140px] sm:min-h-[160px] flex flex-col justify-center">
        ...
        <section className="py-16 bg-slate-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="text-3xl font-extrabold text-[#2563eb]">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200/80 hover:shadow-xl transition">
                ...
                <h3 className="text-xl font-bold text-[#2563eb] mb-3">Our Mission</h3>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200/80 hover:shadow-xl transition">
                ...
                <h3 className="text-xl font-bold text-[#2563eb] mb-3">Our Core Values</h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={c.title} className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 hover:border-amber-400 transition">
                  ...
                  <h3 className="font-bold text-[#2563eb] text-lg mb-2">{c.title}</h3>
        ...
        <section className="py-16 bg-[#1e3a8a] text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={s.step} className="flex gap-4 items-start">
                      <div className="w-10 h-10 rounded-xl bg-amber-500 text-[#1e3a8a] font-extrabold flex items-center justify-center shrink-0 text-sm">
                        {s.step}
                      </div>
                      <div>
              ...
              <div className="bg-[#2563eb] p-8 rounded-3xl border border-amber-500/20 shadow-2xl">
        ...
        <section className="py-16 bg-gradient-to-r from-amber-600 to-amber-500 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
            ...
            <Link href="/contact" className="btn-navy !bg-[#1e3a8a] !text-white hover:!bg-[#2563eb] inline-flex">
