...
const dualServicesMap: Record<string, DualServicePageData> = {
  'security-housekeeping': {
    ...
    metaTitle: 'Private Security & Housekeeping Services | Shakti Workforce Private Limited',
    metaDesc: 'PSARA compliant guarding services and professional corporate housekeeping, deep cleaning & facility maintenance by Shakti Workforce Private Limited.',
  ...
  metaTitle: 'Event Management & Cultural Programs | Shakti Workforce Private Limited',
  metaDesc:
  ...
  'training-empowerment': {
    ...
    metaTitle: 'Skill Training & Women Empowerment Initiatives | Shakti Workforce Private Limited',
...
},
{
  ...
  'recruitment-manpower': {
    ...
    metaTitle: 'Job Placement & Manpower Supply | Shakti Workforce Private Limited',
  ...
  'travel-logistics': {
    ...
    metaTitle: 'Tour Travel & Express Courier Logistics | Shakti Workforce Private Limited',
  ...
  'tenders-others': {
    ...
    metaTitle: 'Government Tenders & Corporate Supplies | Shakti Workforce Private Limited',
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!pageData) {
    return { title: 'Service Not Found | Shakti Workforce Private Limited' };
  }
  return {
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-slate-50 min-h-screen">
        {/* Top Hero Banner */}
        <section className="relative py-16 lg:py-24 bg-[#1e3a8a] text-white overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#1e3a8a] via-[#1e3a8a]/90 to-transparent"></div>
          </div>
        ...
        <section className="py-12 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-20">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-[#2563eb] leading-tight">
                    {service1.title}
                  </h2>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 pt-6 border-t border-gray-100">
                <div>
                  <h4 className="font-bold text-[#2563eb] text-sm mb-3">Key Operational Features:</h4>
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h4 className="font-bold text-[#2563eb] text-sm mb-3">Primary Sectors Served:</h4>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#2563eb] text-amber-400 flex items-center justify-center shadow-lg shrink-0">
        ...
        <section className="py-16 bg-[#1e3a8a] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="tel:8080217575" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-white/30 text-white font-semibold hover:bg-white/10 transition-colors text-sm">
                <PhoneCall size={16} /> Call Us: 8080217575
              </a>
            </div>
          </div>
        </section>
