...
export default function AdminSignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2563eb] via-[#2563eb] to-[#3b82f6] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="text-left">
              <div className="text-white font-bold leading-tight">Shakti Workforce Private Limited</div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <h1 className="text-2xl font-extrabold text-[#2563eb] mb-1">Set up admin access</h1>
