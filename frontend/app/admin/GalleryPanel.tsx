      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-4 mb-6 flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto shrink-0 justify-end">
          ...
          <button
            ...
            className="btn-gold inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg text-sm font-bold shadow-md bg-[#2563eb] text-amber-400 hover:bg-[#3b82f6] transition-colors w-full md:w-auto"
          >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center sm:p-4">
          <div className="bg-white max-w-lg w-full h-full sm:h-auto sm:max-h-[90vh] sm:rounded-2xl overflow-hidden shadow-2xl border-t sm:border border-gray-200 flex flex-col">
            <div className="px-6 py-4 bg-[#2563eb] text-white flex items-center justify-between border-b border-white/10 shrink-0">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Corporate Tower, Bhiwandi"
                    value={location}
              ...
              <div className="pt-4 border-t border-gray-100 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="px-4 py-2 bg-[#2563eb] text-white font-semibold rounded-lg text-sm hover:bg-[#3b82f6] transition-colors flex items-center gap-1.5 disabled:opacity-50"
                >
                  {uploading ? (
                    <>
