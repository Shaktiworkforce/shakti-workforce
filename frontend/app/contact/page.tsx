...
export const metadata: Metadata = {
  title: 'Contact Us | Shakti Workforce Private Limited',
  description:
    'Contact Shakti Workforce Private Limited for private security, housekeeping, and manpower quotes. Reach our team directly or visit our office in Bhiwandi, Thane.',
};
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-slate-50">
        ...
        {/* Quick Contact Bar for General Info */}
        <section className="py-8 bg-amber-500 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid sm:grid-cols-3 gap-4 text-center">
              <div className="p-4 bg-[#1e3a8a] rounded-xl text-white shadow-md border border-amber-400/20">
                <div className="text-xs font-extrabold uppercase text-amber-400 tracking-wider">Helpline</div>
                <div className="text-base font-extrabold text-white my-0.5">
                  <a href="tel:8080217575" className="text-sm font-bold text-white underline hover:text-amber-300 transition">
                    +91 8080217575
                  </a>
                </div>
              </div>
              ...
              <div className="p-4 bg-[#1e3a8a] rounded-xl text-white shadow-md border border-amber-400/20">
                <div className="text-xs font-extrabold uppercase text-amber-400 tracking-wider">Email</div>
                <div className="text-base font-extrabold text-white my-0.5">
                  <a href="mailto:Info@shaktiworkforce.com" className="text-sm font-bold text-white underline hover:text-amber-300 transition">
              ...
              <div className="p-4 bg-[#1e3a8a] rounded-xl text-white shadow-md border border-amber-400/20">
                <div className="text-xs font-extrabold uppercase text-amber-400 tracking-wider">Office Hours</div>
                <div className="text-base font-extrabold text-white my-0.5">Mon – Sat: 9:00 AM – 7:00 PM</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white border-t border-gray-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="space-y-6">
              {[
                {
                  q: 'How fast can Shakti Workforce Private Limited deploy security personnel to a new site?',
                ...
                <div key={item.q} className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80">
                  <h3 className="font-bold text-[#2563eb] text-base mb-2 flex items-start gap-2">
