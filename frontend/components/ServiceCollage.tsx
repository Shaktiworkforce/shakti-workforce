      ...
      >
        {!isFailed ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-[#2563eb] to-slate-800 p-4 flex flex-col items-center justify-center text-center text-white">
            ...
            <span className="text-[10px] text-gray-400">Shakti Workforce Private Limited Certified Service</span>
          </div>
        )}
  ...
  return (
    <div>
      ...
      {activeImage && (
        ...
        >
          <div
            className="relative max-w-4xl w-full bg-[#2563eb] rounded-3xl overflow-hidden shadow-2xl border border-amber-500/30"
          ...
          >
            ...
            <div className="p-4 sm:p-6 bg-[#2563eb] text-white flex items-center justify-between gap-4">
              <div>
