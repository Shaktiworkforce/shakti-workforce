...
const reviews: Review[] = [
  {
    ...
    date: '2 weeks ago',
    comment:
      'Shakti Workforce Private Limited has been instrumental in managing our multi-site facilities. Their team is exceptionally disciplined, punctual, and proactive. The level of operational control they bring is unmatched.',
  ...
  },
  {
    ...
    initials: 'AV',
    avatarBg: 'from-[#2563eb] to-blue-900',
    rating: 5,
    date: '1 month ago',
    comment:
      'Finding skilled and background-verified support staff used to be a major challenge for us. Shakti Workforce Private Limited stepped in with a tailored staffing model that seamlessly fulfilled all our requirements within 48 hours.',
  ...
  },
  {
    ...
    date: '3 weeks ago',
    comment:
      'We engaged Shakti Workforce for comprehensive housekeeping and security services. Their staff adheres strictly to hospitality standards and safety protocols. Their executive oversight is truly commendable.',
  ...
  },
  {
    ...
    initials: 'MP',
    avatarBg: 'from-[#2563eb] to-slate-800',
    rating: 5,
    date: '2 months ago',
    comment:
      'Zero compliance hiccups and total transparency in billing. The team leadership at Shakti Workforce Private Limited is always accessible and addresses feedback instantly. We are thoroughly impressed with their partnership.',
  ...
  },
  {
    ...
    category: 'Facility Management',
    initials: 'PD',
    avatarBg: 'from-slate-700 to-[#2563eb]',
    rating: 5,
    date: '3 weeks ago',
    comment:
...
export default function Reviews() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 -right-20 w-80 h-80 bg-[#2563eb]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10 lg:mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#2563eb] leading-tight">
          ...
          {reviews.map((rev) => (
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Highlight banner */}
                <div className="flex items-start gap-1.5 mb-3 text-xs font-semibold text-[#2563eb]">
              ...
              <div className="pt-4 border-t border-gray-100 flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    <h4 className="font-bold text-[#2563eb] text-sm truncate">{rev.name}</h4>
