      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <p className="text-gray-600 leading-relaxed text-sm">
            Shakti Workforce Private Limited is proud to be an ISO 9001:2015 Certified Company —
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="absolute -top-3 -right-3 bg-[#2563eb] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg border border-amber-400/30">
                ISO Certified
              </div>
          ...
          <div>
            <div className="grid gap-3">
              {trustPoints.map((point, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-[#2563eb] mb-1 group-hover:text-amber-600 transition-colors">
                      {point.title}
                    </h3>
            ...
            {/* Bottom trust strip */}
            <div className="mt-4 flex items-center gap-4 bg-gradient-to-r from-[#2563eb] to-[#3b82f6] rounded-xl px-6 py-3 shadow-lg">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/ISO.jpeg"
                alt="ISO Badge"
