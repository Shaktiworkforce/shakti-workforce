      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
              ...
              <img
                ...
                alt="Shakti Workforce Team"
                className="w-full h-[360px] sm:h-[420px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#2563eb]/70 via-transparent to-transparent"></div>
            </div>
            ...
            <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-xl border border-amber-200/50 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-bold text-[#2563eb]">ISO 9001:2015</div>
                <div className="text-[10px] font-semibold text-amber-600">Certified Company</div>
              </div>
            </div>

            {/* Bottom floating stat card */}
            <div className="absolute -bottom-6 left-6 sm:left-10 bg-[#2563eb] text-white rounded-2xl p-5 shadow-2xl border border-amber-500/30 flex items-center gap-4">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#2563eb] mb-5 leading-tight">
              Service With Integrity, Built On Unwavering Trust
            </h2>

            <p className="text-gray-600 text-base leading-relaxed mb-6">
              Shakti Workforce Private Limited is a premier Indian security, facility management, and manpower enterprise headquartered in Bhiwandi, Maharashtra. We deliver rigorous, fully compliant, and customized workforce solutions to safeguard and empower businesses across India.
            </p>
