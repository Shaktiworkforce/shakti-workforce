...
const services = [
  ...
  { icon: Building2, title: 'Warehouse & Logistics Staff', desc: 'Warehouse and logistics workforce for inventory handling, dispatch support, and daily operations.', img: 'skill_unskill3.jpg' },
  { icon: Boxes, title: 'Packing Staff', desc: 'Trained packing staff for warehouses, factories, e-commerce operations, and dispatch centres.', img: 'skill_unskill4.webp' },
  { icon: ScanLine, title: 'Scanning Staff', desc: 'Scanning and documentation staff for inventory, records, parcels, warehouses, and offices.', img: 'c1.jpg' },
  { icon: Factory, title: 'Manufacturing Workforce', desc: 'Workforce deployment for manufacturing units, production lines, assembly operations, and industrial support.', img: 'skill1.jpeg' },
  ...
  { icon: HardHat, title: 'Loading & Unloading Labour', desc: 'Loading and unloading labour for warehouses, factories, transport operations, and material handling.', img: 'skill3.jpeg' },
