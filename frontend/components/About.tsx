      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 -right-2 sm:right-0 lg:-right-6 bg-[#2563eb] text-white rounded-2xl p-5 sm:p-6 shadow-xl max-w-[200px]">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-[36px] font-extrabold text-[#2563eb] mb-6 leading-[1.15]">
            ...
            <div className="space-y-5">
              {values.map((v) => (
                <div key={v.title} className="flex gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-[14px] text-[#2563eb] mb-1">{v.title}</h3>
