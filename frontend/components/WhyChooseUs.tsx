...
export default function WhyChooseUs() {
  return (
    <section className="py-12 lg:py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-56 h-56 bg-[#2563eb]/5 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 lg:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#2563eb] mb-4 leading-tight">
          ...
          {features.map((f, i) => (
            ...
            >
              ...
              <div className="relative flex flex-col h-full">
                ...
                <h3 className="font-bold text-[#2563eb] mb-1.5 group-hover:text-amber-600 transition-colors text-[15px]">
                  {f.title}
                </h3>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 lg:p-8 mb-10 lg:mb-14">
          <div className="flex flex-col lg:flex-row items-center gap-6">
            <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-2xl bg-[#2563eb] shadow-lg">
              <ShieldCheck className="text-amber-400" size={28} />
            </div>
            <div className="text-center lg:text-left flex-grow">
              <h3 className="text-xl font-bold text-[#2563eb] mb-1">Trust & Compliance Built In</h3>
